...
public class AfterCommitExecutor extends TransactionSynchronizationAdapter implements IntactTransactionSynchronization, Executor {
    private static final Logger LOGGER = Logger.getLogger("AfterCommitExecutor");
