...
public class IntactSchemaUtilsTest {
    ...
    public void testGenerateCreateSchemaDDLForOracle() throws Exception {
        ...
        Assert.assertEquals(278, strings.length);
        Assert.assertEquals(278, IntactSchemaUtils.generateCreateSchemaDDLForPostgreSQL().length);
        Assert.assertEquals(278, IntactSchemaUtils.generateCreateSchemaDDLForHSQL().length);
        Assert.assertEquals(278, IntactSchemaUtils.generateCreateSchemaDDLForH2().length);
    }
}
