...
public class IntactSchemaUtilsTest {
    ...
    public void testGenerateCreateSchemaDDLForOracle() throws Exception {
        ...
        Assert.assertEquals(273, strings.length);
        Assert.assertEquals(273, IntactSchemaUtils.generateCreateSchemaDDLForPostgreSQL().length);
        Assert.assertEquals(273, IntactSchemaUtils.generateCreateSchemaDDLForHSQL().length);
        Assert.assertEquals(273, IntactSchemaUtils.generateCreateSchemaDDLForH2().length);
    }
}
