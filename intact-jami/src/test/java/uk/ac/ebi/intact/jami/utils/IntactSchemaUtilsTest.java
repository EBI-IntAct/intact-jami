...
public class IntactSchemaUtilsTest {
    ...
    public void testGenerateCreateSchemaDDLForOracle() throws Exception {
        ...
        Assert.assertEquals(270, strings.length);
        Assert.assertEquals(270, IntactSchemaUtils.generateCreateSchemaDDLForPostgreSQL().length);
        Assert.assertEquals(270, IntactSchemaUtils.generateCreateSchemaDDLForHSQL().length);
        Assert.assertEquals(270, IntactSchemaUtils.generateCreateSchemaDDLForH2().length);
    }
}
