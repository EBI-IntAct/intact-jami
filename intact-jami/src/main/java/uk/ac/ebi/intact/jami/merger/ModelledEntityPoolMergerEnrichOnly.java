...
public class ModelledEntityPoolMergerEnrichOnly
        extends ModelledParticipantMergerEnrichOnly<ModelledEntityPool, IntactModelledEntityPool> implements EntityPoolEnricher<ModelledEntityPool, ModelledFeature>{

    public ModelledEntityPoolMergerEnrichOnly() {
        super(IntactModelledEntityPool.class, new FullEntityPoolEnricher<ModelledEntityPool, ModelledFeature>());
    }

    public ModelledEntityPoolMergerEnrichOnly(EntityPoolEnricher<ModelledEntityPool, ModelledFeature> basicEnricher) {
