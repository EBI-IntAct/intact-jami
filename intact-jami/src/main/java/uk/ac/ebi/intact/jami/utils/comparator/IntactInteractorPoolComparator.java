...
public class IntactInteractorPoolComparator extends UnambiguousExactInteractorPoolComparator
implements IntactComparator<InteractorPool>{
    ...
    public boolean canCompare(InteractorPool objectToCompare) {
        ...
        for (Interactor i : objectToCompare){
            if (!UnambiguousIntactInteractorBaseComparator.canCompareAllProperties(i)){
                return false;
            }
        }
