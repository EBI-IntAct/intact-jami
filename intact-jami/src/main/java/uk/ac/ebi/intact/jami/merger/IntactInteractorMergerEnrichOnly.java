...
public class IntactInteractorMergerEnrichOnly extends IntactDbMergerEnrichOnly<IntactInteractor> implements InteractorEnricher<Interactor> {

    private InteractorEnricher<Interactor> interactorEnricher;

    public IntactInteractorMergerEnrichOnly(IntactInteractorSynchronizer intactSynchronizer){
        this.interactorEnricher = new FullInteractorEnricher(intactSynchronizer);
    }

    protected IntactInteractorMergerEnrichOnly(InteractorEnricher<Interactor> interactorEnricher){
