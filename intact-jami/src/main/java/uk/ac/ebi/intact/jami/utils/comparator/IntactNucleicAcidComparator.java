...
import psidev.psi.mi.jami.utils.comparator.interactor.NucleicAcidComparator;
...
public class IntactNucleicAcidComparator extends NucleicAcidComparator
implements IntactComparator<NucleicAcid>{

    public IntactNucleicAcidComparator() {
     ...
     */
    public boolean canCompare(NucleicAcid objectToCompare) {
