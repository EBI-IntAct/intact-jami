...
import psidev.psi.mi.jami.enricher.impl.FullInteractionEvidenceEnricher;
...
public class IntactInteractionEvidenceMergerEnrichOnly extends IntactDbMergerEnrichOnly<InteractionEvidence,IntactInteractionEvidence> implements InteractionEvidenceEnricher {

    public IntactInteractionEvidenceMergerEnrichOnly(){
        super(new FullInteractionEvidenceEnricher());
    }

    protected IntactInteractionEvidenceMergerEnrichOnly(InteractionEvidenceEnricher interactorEnricher){
