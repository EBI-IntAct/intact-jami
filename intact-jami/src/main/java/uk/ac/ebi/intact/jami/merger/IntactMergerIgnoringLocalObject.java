...
public class IntactMergerIgnoringLocalObject<I,T extends Auditable> extends AbstractMIEnricher<I> implements IntactDbMerger<I,T>{

    private IntactDbSynchronizer<I,T> dbSynchronizer;

    public IntactMergerIgnoringLocalObject(IntactDbSynchronizer<I, T> dbSynchronizer){
