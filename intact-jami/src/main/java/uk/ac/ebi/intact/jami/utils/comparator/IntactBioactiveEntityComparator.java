...
import psidev.psi.mi.jami.utils.comparator.interactor.BioactiveEntityComparator;
...
public class IntactBioactiveEntityComparator extends BioactiveEntityComparator
implements IntactComparator<BioactiveEntity>{
     ...
     */
    public boolean canCompare(BioactiveEntity objectToCompare) {
