...
public class IntactModelledParticipantMergerEnrichOnly<E extends ModelledParticipant, I extends IntactModelledParticipant>
        extends IntactEntityMergerEnrichOnly<E, I, ModelledFeature> {

    public IntactModelledParticipantMergerEnrichOnly() {
        super((Class<I>)IntactModelledParticipant.class, new FullParticipantEnricher<E, ModelledFeature>());
    }

    public IntactModelledParticipantMergerEnrichOnly(ParticipantEnricher<E, ModelledFeature> basicEnricher) {
        super((Class<I>)IntactModelledParticipant.class, basicEnricher);
    }

    public IntactModelledParticipantMergerEnrichOnly(Class<I> intactClass) {
        super(intactClass, new FullParticipantEnricher<E, ModelledFeature>());
    }

    public IntactModelledParticipantMergerEnrichOnly(Class<I> intactClass, ParticipantEnricher<E, ModelledFeature> basicEnricher) {
