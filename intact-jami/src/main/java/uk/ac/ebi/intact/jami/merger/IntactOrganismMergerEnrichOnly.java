...
public class IntactOrganismMergerEnrichOnly extends IntactDbMergerEnrichOnly<IntactOrganism> implements OrganismEnricher{
    ...
    public IntactOrganismMergerEnrichOnly(IntactOrganismSynchronizer intactSynchronizer){
        this.organismEnricher = new FullOrganismEnricher(intactSynchronizer);
    }
