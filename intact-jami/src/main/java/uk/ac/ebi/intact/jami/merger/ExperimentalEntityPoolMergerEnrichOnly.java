...
public class ExperimentalEntityPoolMergerEnrichOnly
        extends ParticipantEvidenceMergerEnrichOnly<ExperimentalEntityPool, IntactExperimentalEntityPool> implements EntityPoolEnricher<ExperimentalEntityPool, FeatureEvidence>, ParticipantEvidenceEnricher<ExperimentalEntityPool>{

    public ExperimentalEntityPoolMergerEnrichOnly() {
        super(IntactExperimentalEntityPool.class, new FullExperimentalEntityPoolEnricher());
    }

    public ExperimentalEntityPoolMergerEnrichOnly(ParticipantEvidenceEnricher<ExperimentalEntityPool> basicEnricher) {
