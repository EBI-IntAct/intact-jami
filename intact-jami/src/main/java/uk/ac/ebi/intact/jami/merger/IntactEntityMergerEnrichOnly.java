...
public class IntactEntityMergerEnrichOnly<E extends Entity, I extends AbstractIntactEntity, F extends Feature> extends IntactDbMergerEnrichOnly<E, I> implements ParticipantEnricher<E,F> {

    public IntactEntityMergerEnrichOnly() {
        super((Class<I>)AbstractIntactEntity.class, new FullParticipantEnricher<E,F>());
    }

    public IntactEntityMergerEnrichOnly(ParticipantEnricher<E,F> basicEnricher) {
        super((Class<I>)AbstractIntactEntity.class, basicEnricher);
    }

    public IntactEntityMergerEnrichOnly(Class<I> intactClass) {
        super(intactClass, new FullParticipantEnricher<E,F>());
    }

    public IntactEntityMergerEnrichOnly(Class<I> intactClass, ParticipantEnricher<E,F> basicEnricher) {
