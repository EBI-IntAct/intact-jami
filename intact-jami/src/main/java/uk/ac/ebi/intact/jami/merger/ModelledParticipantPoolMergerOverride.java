...
import psidev.psi.mi.jami.enricher.impl.full.FullParticipantPoolUpdater;
...
public class ModelledParticipantPoolMergerOverride
        extends ModelledParticipantMergerOverride<ModelledParticipantPool, IntactModelledParticipantPool> implements ParticipantPoolEnricher<ModelledParticipantPool, ModelledFeature> {

    public ModelledParticipantPoolMergerOverride() {
        super(IntactModelledParticipantPool.class, new FullParticipantPoolUpdater<ModelledParticipantPool, ModelledFeature>());
    }

    public ModelledParticipantPoolMergerOverride(ParticipantPoolEnricher<ModelledParticipantPool, ModelledFeature> basicEnricher) {
