 ...
 */
public interface ImexExportDao extends BaseDao {

    List<ImexExport> getDeletedAfter(Date date);

    List<ImexExport> getUpdatedAfter(Date date);

    List<ImexExport> getCreatedAfter(Date date);
